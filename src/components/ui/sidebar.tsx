...
function Sidebar({
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          ...
          <div className="flex h-full w-full flex-col outline-0! border-0!">{children}</div>
        </SheetContent>
      </Sheet>
    );
  }
  ...
  return (
    <div
      className={cn('group peer hidden text-sidebar-foreground md:hidden', className)}
      data-state={state}
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <HugeiconsIcon icon={Hamburger} strokeWidth={2} className="rtl:rotate-180  size-full" />
